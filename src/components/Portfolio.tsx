...
const projects: Project[] = [
  ...
  },
  {
    id: 'tapn',
    title: 'tapn.',
    subtitle: 'autonomous multi-agent job search ecosystem',
    description: [
      'architected a <strong>six-agent autonomous pipeline</strong> on the <strong>OpenClaw</strong> framework that analyzes workforce data, tailors resumes, submits applications, manages recruiter correspondence, and conducts real-time mock interviews w/ zero manual input',
      'engineered a workforce signal model in <strong>DuckDB</strong> processing <strong>~75,000 records</strong> across five custom features to score <strong>~500 companies</strong> in <strong>~15 seconds</strong>, replacing job board dependency with leading hiring indicators',
      'designed an anti-fabrication resume tailoring agent that extracts <strong>ATS keywords</strong> from job descriptions, restructures content via <strong>LaTeX PDF generation</strong>, and enforces a traceability constraint ensuring every item maps to the original resume',
      'integrated <strong>ElevenLabs Conversational AI</strong> with signed URL authentication to deliver role-specific voice mock interviews, dynamically generating <strong>15–20 custom questions</strong> and scoring transcripts across <strong>five performance dimensions</strong>',
    ],
    techStack: ['React', 'OpenClaw', 'Supabase', 'ElevenLabs', 'DuckDB', 'Three.js'],
  ...
  },
  {
    ...
    description: [
      'built with <strong>React</strong> and <strong>TypeScript</strong> using <strong>Vite</strong> for fast development and optimized production builds',
      'designed with <strong>Tailwind CSS</strong> and <strong>Framer Motion</strong> for smooth animations and responsive layouts',
      'deployed on <strong>Vercel</strong> with automatic CI/CD from GitHub',
      'features <strong>Three.js</strong> WebGL effects, video backgrounds, and dark mode support',
    ],
